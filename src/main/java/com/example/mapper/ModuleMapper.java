...
public interface ModuleMapper
{
    ...
    @Insert("insert into module(module_index,project_id,location,date,date_of_string,time,stu_num) values(#{module_index},#{project_id},#{location},#{date},#{dateOfString},#{time},#{stu_num})")
    ...
    @Select("select * from module ordered by date")
